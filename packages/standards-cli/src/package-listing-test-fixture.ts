export const expectedPackedFiles = [
  ...
  'package/README.md',
  'package/src/cli.ts',
  'package/src/git-child-environment.ts',
  ...
  'package/src/github-declaration.ts',
  ...
  'package/src/github-environment-custom-apply.ts',
  ...
  'package/src/github-ruleset-reconcile.ts',
  ...
  'package/src/sync-file-inspection.ts',
  ...
  'package/src/sync-git-exclude.ts',
  'package/src/sync-git-metadata-directory.ts',
  ...
  'package/src/sync-node-generation.ts',
  'package/src/sync-node-identity.ts',
  'package/src/sync-policy.ts',
  'package/src/sync-process-identity.ts',
  'package/src/sync-repository-root-generation.ts',
  'package/src/sync-root-path.ts',
  'package/src/sync-source-file.ts',
  'package/src/sync-source-node.ts',
  'package/src/sync-source-parent.ts',
  'package/src/sync-source-selection.ts',
  'package/src/sync-source-traversal.ts',
  'package/src/sync-source-types.ts',
  'package/src/sync-source-validation.ts',
  ...
  'package/src/sync-transaction-prune-validation.ts',
